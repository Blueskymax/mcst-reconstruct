...
from data.load_data import DataLoadOneManeuveringTarget3d
...
if __name__ == '__main__':
    ...
    train_data = DataLoadOneManeuveringTarget3d(data_path=args.data_dir,is_train=1,n_frames=args.frame_max)
    test_data = DataLoadOneManeuveringTarget3d(data_path=args.data_dir,is_train=0,n_frames=args.frame_max)

    # 按照batch_size划分
    train_load = DataLoader(train_data, args.train_batch_size, shuffle=True)
    test_load = DataLoader(test_data, args.eval_batch_size, shuffle=True)
